...
| Battiston, S. et al. | 2012 | DebtRank: Too central to fail? Financial networks, the FED and systemic risk | Scientific Reports | システム的重要性のためのDebtRank中心性指標; FRBの緊急融資への適用 |
...
| Billio, M. et al. | 2012 | Econometric measures of connectedness and systemic risk in the finance and insurance sectors | Journal of Financial Economics | システム的接続性を計測するためのグレンジャー因果性ネットワーク; PCAベースの指標 |
...
| Bardoscia, M. et al. | 2017 | Pathways towards instability in financial networks | Nature Communications | フォワードルッキング型伝染モデル; デフォルトなしのストレス伝播 |
...
| 著者 | 年 | タイトル | 発表媒体 | 主要な貢献 |
|------|-----|---------|----------|-----------|
| Vitali, S., Glattfelder, J.B. & Battiston, S. | 2011 | The network of global corporate control | PLOS ONE | 多国籍企業のグローバル所有ネットワークのマッピング; ボウタイトポロジー; 147のスーパーエンティティ |
...
| Davis, G., Yoo, M. & Baker, W. | 2003 | The small world of the American corporate elite, 1982–2001 | Strategic Organization | 米国企業取締役会ネットワークのスモールワールド特性 |
...
| Kogut, B. & Walker, G. | 2001 | The small world of Germany and the durability of national networks | American Sociological Review | ドイツ企業ネットワークのスモールワールド構造 |
...
| Carvalho, V. | 2014 | From micro to macro via production networks | Journal of Economic Perspectives | 生産ネットワークトポロジーがマクロ経済成果をどう形成するかのサーベイ |
...
| Baqaee, D. & Farhi, E. | 2019 | The macroeconomic impact of microeconomic shocks | Econometrica | 生産ネットワークを通じたショックの非線形伝播 |
| Carvalho, V. & Tahbaz-Salehi, A. | 2019 | Production networks: A primer | Annual Review of Economics | 生産ネットワーク経済学の包括的入門 |
...
| Ron, D. & Shamir, A. | 2013 | Quantitative analysis of the full bitcoin transaction graph | Financial Cryptography | ビットコイントランザクションネットワークトポロジーの初期分析 |
...
| Barbereau, T. et al. | 2022 | DeFi, not so decentralized: The measured distribution of voting rights | HICSS | DeFiプロトコルにおけるガバナンスの集中 |
...
| 著者 | 年 | タイトル | 発表媒体 | 主要な貢献 |
|------|-----|---------|----------|-----------|
| Adrian, T. & Brunnermeier, M. | 2016 | CoVaR | American Economic Review | 条件付きバリューアットリスクによるシステミックリスク指標 |
...
| Monasterolo, I. & de Angelis, L. | 2020 | Blind to carbon risk? | Ecological Economics | 金融ネットワークを通じた気候政策リスクの伝播 |
